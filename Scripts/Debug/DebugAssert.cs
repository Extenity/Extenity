...
public class DebugAssert
{
	...
	[Conditional("UNITY_EDITOR"), Conditional("DEBUG")] public static void IsAlmostEqual(float value1, float value2, float tolerance) { InternalCheck(Math.Abs(value1 - value2) <= tolerance, null); }
	[Conditional("UNITY_EDITOR"), Conditional("DEBUG")] public static void IsAlmostEqual(float value1, float value2, float tolerance, string assertString) { InternalCheck(Math.Abs(value1 - value2) <= tolerance, assertString); }
