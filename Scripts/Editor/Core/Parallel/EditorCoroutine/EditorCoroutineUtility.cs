...
namespace Extenity.ParallelToolbox.Editor
{
	public static class EditorCoroutineUtility
	{
		...
		public static EditorCoroutine StartCoroutine(IEnumerator routine, object owner, Func<Exception, bool> onException = null)
		{
			return new EditorCoroutine(routine, owner, onException);
		}
		...
		/// <returns>A handle to an <see cref="EditorCoroutine">EditorCoroutine.</see></returns>
		public static EditorCoroutine StartCoroutineOwnerless(IEnumerator routine, Func<Exception, bool> onException = null)
		{
			return new EditorCoroutine(routine, onException);
		}
