...
namespace Extenity.ParallelToolbox.Editor
{
	public static class EditorWindowCoroutineExtension
	{
		...
		/// <returns></returns>
		public static EditorCoroutine StartCoroutine(this EditorWindow window, IEnumerator routine, Func<Exception, bool> onException = null)
		{
			return new EditorCoroutine(routine, window, onException);
		}
