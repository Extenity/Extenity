...
namespace Extenity.MessagingToolbox
{
	...
	public class ExtenityEvent
	{
		...
		private static readonly Dictionary<Action, ProfilerMarker> ProfilerMarkerCache = new Dictionary<Action, ProfilerMarker>();

		private static ProfilerMarker GetOrCreateProfilerMarker(Action callback)
		{
