...
namespace Extenity.MathToolbox
{
	...
	public static class Vector3Tools
	{
		...
		public static Vector3 AddX(this Vector3 value, float addedX) { value.x += addedX; return value; }
		public static Vector3 AddY(this Vector3 value, float addedY) { value.y += addedY; return value; }
		public static Vector3 AddZ(this Vector3 value, float addedZ) { value.z += addedZ; return value; }
		// @formatter:on
