...
namespace Extenity.ApplicationToolbox
{
	...
	public abstract class Clipboard
	{
		...
		public static Clipboard Instance
		{
			...
			{
				if (_Instance == null)
					throw new InternalException(1857182); // Clipboard system is not initialized yet
				return _Instance;
			}
			protected set
			{
				if (_Instance != null)
					throw new InternalException(2857182); // There already was an existing Clipboard system running
				_Instance = value;
			}
		}
