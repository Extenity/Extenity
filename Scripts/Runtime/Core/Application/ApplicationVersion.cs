	...
	public struct ApplicationVersion
	{
		...
		public static void FixVersionConfigurationByChoosingTheHighestVersion()
		{
			...
			catch
			{
				...
				catch { androidVersion = new ApplicationVersion(MinMajorVersion, MinMinorVersion, MinBuildVersion); }
				try { iOSVersion = GetIOSVersion(); }
				catch { iOSVersion = new ApplicationVersion(MinMajorVersion, MinMinorVersion, MinBuildVersion); }
				try { unityVersion = GetUnityApplicationVersion(); }
				catch { unityVersion = new ApplicationVersion(MinMajorVersion, MinMinorVersion, MinBuildVersion); }
