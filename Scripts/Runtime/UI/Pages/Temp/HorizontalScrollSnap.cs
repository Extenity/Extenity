// TODO TEMP: Temporary solution until a scroll snapper is implemented.
...
namespace Extenity.UIToolbox
{
	...
	public class HorizontalScrollSnap : ScrollSnapBase, IEndDragHandler
	{
		void Start()
		{
			...
			UpdateLayout();
			// OnSelectionPageChangedEvent.AddListener(FoodCanvas.instance.OpenTab(_currentPage));
			// OnSelectionPageChangedEvent.AddListener((_currentPage)=>
			// {
			//     FoodCanvas.Instance.OpenTab(_currentPage);
			// });


			// OnSelectionPageChangedEvent.AddListener(FoodCanvas.instance.printme());
		}
