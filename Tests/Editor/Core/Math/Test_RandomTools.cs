...
namespace ExtenityTests.MathToolbox
{
	...
	public class Test_RandomTools : ExtenityTestBase
	{
		...
		public void Test_GenerateTimestampedSeed()
		{
			...
			for (int iRepeat = 0; iRepeat < repeatCount; iRepeat++)
			{
				...
				{
					var seed = RandomTools.GenerateTimestampedSeed();
					if (!bag.Add(seed))
					{
			...
			//
			// See RandomTools.GenerateTimestampedSeed for detailed test results.
