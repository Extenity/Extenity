...
namespace ExtenityTests.AssetToolbox.Editor
{
	...
	public class Test_AssetDatabaseTools : ExtenityTestBase
	{
		#region Script Asset
...
");
			...
			Type expectedExceptionType)
		{
			...
			if (expectedExceptionType != null)
			{
				Assert.Throws(expectedExceptionType, () => AssetDatabaseTools.DeleteCommentsInScriptAssetContents(processedInputLines));
			}
			else
			{
				AssetDatabaseTools.DeleteCommentsInScriptAssetContents(processedInputLines);
