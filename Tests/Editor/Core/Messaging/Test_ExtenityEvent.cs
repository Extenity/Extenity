...
namespace ExtenityTests.MessagingToolbox
{
	...
	public class Test_ExtenityEvent : Test_EventTestBase
	{
		...
		{
			TestEvent.AddListener(CallbackOnA, null);
			TestEvent.AddListener(CallbackOnB, null);
			TestEvent.AddListener(CallbackOnC, null);
		...
		{
			TestEvent.AddListener(CallbackOnA, null, -10);
			TestEvent.AddListener(CallbackOnB, null, -20);
			TestEvent.AddListener(CallbackOnC, null, -30);
		...
		{
			TestEvent.AddListener(CallbackOnA, null, -10);
			TestEvent.AddListener(CallbackOnB, null, -10);
			TestEvent.AddListener(CallbackOnC, null, 0);
			TestEvent.AddListener(CallbackOnD, null, 0);
			TestEvent.AddListener(CallbackOnE, null, 30);
			TestEvent.AddListener(CallbackOnF, null, 30);
		...
		{
			TestEvent.AddListener(CallbackOnA, null, 10);
			TestEvent.AddListener(ThrowingCallback, null, 20);
			TestEvent.AddListener(CallbackOnC, null, 30);
		...
		{
			TestEvent.AddListener(CallbackOn, CallbackOff);
			AssertExpectLog((LogType.Log, "Called SwitchOff callback."));
		...
		public void AddingDifferentSetsOfListenersConsideredNotTheSame_Take1()
		{
			...
			TestEvent.AddListener(CallbackOnA, CallbackOffB);
		...
		public void AddingDifferentSetsOfListenersConsideredNotTheSame_Take2()
		{
			...
			TestEvent.AddListener(CallbackOnB, CallbackOffA);
			AssertExpectLog((LogType.Log, "Called SwitchOff callback A."));
		...
		{
			TestEvent.AddListener(null, CallbackOffA);
			AssertExpectLog((LogType.Log, "Called SwitchOff callback A."));
		...
		{
			TestEvent.AddListener(null, CallbackOffA, 0, ListenerLifeSpan.RemovedAtFirstEmit);
			AssertExpectLog((LogType.Log, "Called SwitchOff callback A."));
		...
		{
			TestEvent.AddListener(null, null);
